...
PATH_TRAIN_LABEL = PATH_DATA_FOLDER +  'brite_mph_train.txt'
PATH_TRAIN_IMAGES_FOLDER = PATH_DATA_FOLDER +  'brite_train_images/'
PATH_TRAIN_IMAGES_FLOW_FOLDER = PATH_DATA_FOLDER +  'brite_train_images_flow/'
    ...
    for index in range(len(labels_string)):
        ...
        if index in filtered_list_indexes:
            ...
            if type == TYPE_FLOW_PRECOMPUTED:
                ...
                train_images_pair_paths.append( ( os.getcwd() + images_path[1:] + str(index)+ '.jpg',  os.getcwd() + flow_images_path[1:] + str(index) + '.jpg',   os.getcwd() + flow_images_path[1:] + str(index) + '.jpg',   os.getcwd() + flow_images_path[1:] + str(index) + '.jpg',  os.getcwd() + flow_images_path[1:] + str(index) + '.jpg') )
            else:
